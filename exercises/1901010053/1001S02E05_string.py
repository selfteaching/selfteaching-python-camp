...
#2.将含有ea的单词删除
string2 = string1.split() #str.split()分割字符串，默认以空格进行分割
string3="ea" 
string4=[]
for i in string2:
    if i.find(string3)<0: #单词不含有‘ea'
        string4.append(i) #append()用于在【列表】末尾添加新的对象 ，并修改原列表
string5=" ".join(string4) #str.join(obj)通过指定字符连接序列中元素后生成的新字符串.将列表string4转换为新的字符串string5.
