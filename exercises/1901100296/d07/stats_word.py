...
if __name__=='__main__':
    ...
    ⼀天，愚公召集家人說:「讓我們各盡其力，剷平⼆山，開條道路，直通豫州，你們認為怎樣?」
    ⼤家都異口同聲贊成，只有他的妻子表示懷疑，並說:「你連開鑿一個小丘的⼒量都沒有，怎可能剷平太行、王屋二山呢?況且，鑿出的⼟石⼜丟到哪裏去呢?」
    ⼤家都熱烈地說:「把⼟石丟進渤海裏。」
    於是愚公就和兒孫，⼀一起開挖土，把⼟石搬運到渤海去。
    愚公的鄰居是個寡婦，有個兒⼦子八歲也興致勃勃地走來幫忙。
    寒來來暑往，他們要⼀年才能往返渤海一次。
    住在⿈河畔的智叟，看⾒他們這樣⾟辛苦，取笑愚公說:「你不是很愚蠢嗎?你已一把年年紀了了，就是用盡你的氣力，也不能挖去山的⼀角呢?」
    愚公歎息道:「你有這樣的成⾒，是不會明⽩的。你⽐那寡婦的⼩兒子還不如呢!就算我死了，還有我的兒子，我的孫子，我的曾孫子，他們⼀直傳下去。而這二山是不會加大的，總有⼀一天，我們會把它們剷平。」
    智叟聽了了，無話可說:
    二山的守護神被愚公的堅毅精神嚇倒，便把此事奏知天帝。天帝佩服愚公的精神，就命兩位⼤力神揹走⼆山。
