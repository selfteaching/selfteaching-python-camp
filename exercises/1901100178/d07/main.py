...
太行，王屋二山的北面，住了一個九十歲的老老翁，名叫愚公。二山佔地廣闊，擋住去路，使他和家人往來極為不便。

一天，愚公召集家人說：「讓我們各盡其力，剷平二山，開條道路，直通豫州，你們認為怎樣？」
大家都異口同聲贊成，只有他的妻子表示懷疑，並說：「你連開鑿一個小丘的力量都沒有，怎可能剷平太行、王屋二山呢？況且，鑿出的土石又丟到哪裏去呢？」
...
住在黃河河畔的智叟，看見他們這樣辛苦，取笑愚公說：「你不不是很愚蠢嗎？你已一把年紀
了，就是用盡你的氣力，也不能挖去山的一角呢？」

愚公歎息道：「你有這樣的成見，是不會明白的。你比那寡婦的小兒子還不如呢！就算我死
...
# print(stats_word.stats_text(text1))
print(stats_word.stats_text(text1))