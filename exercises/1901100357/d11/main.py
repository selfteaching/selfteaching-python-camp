...
if __name__ == "__main__":
	...
	list1 = stats_word.stats_text_cn(content, 100)
	res = ''.join(str(i) for i in list1)
	print(res, type(res))
	...
	contents = [res]
	yag.send(recipients, '【1901100357】自学训练营学习20群 DAY11 freakoutbug', contents)
