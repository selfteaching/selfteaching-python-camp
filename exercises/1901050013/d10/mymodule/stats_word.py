...
def stats_text_cn(text):
    ...
    text3 = list(text2) # Convert the string type to the list type.
    text4 = [x for x in text3 if len(x)>= 2] # pick out the length of words that contain at least two characters.
    return Counter(text4).most_common(20) # Count the times of each character in the list. Sort the character in the descending order according to the times of characters. Return the result. 
