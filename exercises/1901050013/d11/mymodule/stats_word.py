...
def stats_text_cn(text):
    ...
    return Counter(text3).most_common(100) # Count the times of each character in the list. Sort the character in the descending order according to the times of characters. Return the result. 
