#通过模块导入stats_word，调用stats_text统计字符串样本中文汉字和英⽂单词出现的次数
from mymodule import stats_word
sample_text = '''
愚公移山
太行王屋的北面，住了一個九十歲的老翁，名叫愚公。二山佔地廣闊，擋住去路，使他和家人往來極為不便。
一天，愚公召集家人說：「讓我們各盡其力，剷平二山開條道路，直通豫州，你們認為怎樣？」
大家都異口同聲贊成，只有他的妻子表示懷疑，並說：「你連開鑿一個小丘的力量都沒有，怎可能剷平太行王屋二山呢？況且，鑿出的石头丟到哪裏去呢？」
大家都熱烈地說：「把石丟進渤海裏。」
於是愚公就和兒孫，一起開挖土，把土石搬運到渤海去。
愚公的鄰居是個寡婦，有個兒子八歲也興致勃勃地走來幫忙。
寒來暑往，他們要一年年才能往返渤海一次。
住在黃河河畔的智叟，看見他們這樣辛苦，取笑愚公說：「你不是很愚蠢嗎？你已大把年紀了，就是用盡你的氣也不不能挖去二山的一⻆呢？」
愚公歎息道：「你有這樣的成是不會明白的。你比那寡婦的小兒子還不如呢！就算我死了，還有我的兒和我的孫我的曾孫他們一直傳下去。這山是不會加的，總有一天，我們會把它們剷平。」
智叟聽了，無話可說：
守護神被愚公的堅毅精神嚇倒，便把此事奏知天帝。天帝佩服愚公的精神，就命兩位天神背走二山。
...
around.
One day yugong gathered his family together and said,”Let’s do our best to level these two mountains. We shall open a road that leadsto Yuzhou. What do you think?”
...
So Yugong, his sons, and his grandsons started to break up rocks andremove the earth. They transported the earth and rubble to the Sea of Bohai.
...
for his wisdom. When he saw their back-breaking labour, he ridiculed Yugong saying,”Aren’t you foolish, my friend? You are very old now, and with whatever remains of your waning strength, you won’t be able to remove even a corner of the mountain.”
