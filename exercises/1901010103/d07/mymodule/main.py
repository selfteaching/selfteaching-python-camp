...
from d07.mymodule.stats_word import stats_text


text = '''
愚公移⼭
太⾏，王屋二⼭的北北⾯面，住了⼀個九⼗十歲的老翁，名叫愚公。⼆⼭佔地廣闊，擋住去路路，使他
和家⼈人往來來極為不不便便。
⼀天，愚公召集家⼈說：「讓我們各盡其⼒，剷平⼆⼭山，開條道路路，直通豫州，你們認為怎
樣？」
⼤大家都異異⼝口同聲贊成，只有他的妻⼦子表示懷疑，並說：「你連開鑿⼀一個⼩小丘的⼒力力量量都沒有，怎
可能剷平太⾏行行、王屋⼆二⼭山呢？況且，鑿出的⼟土⽯石⼜又丟到哪裏去呢？」
⼤大家都熱烈烈地說：「把⼟土⽯石丟進渤海海裏。」
於是愚公就和兒孫，⼀一起開挖⼟，把⼟⽯搬運到渤海海去。
愚公的鄰居是個寡婦，有個兒⼦子⼋歲也興致勃勃地⾛走來來幫忙。
寒來來暑往，他們要⼀年才能往返渤海海⼀次。
住在⿈黃河河畔的智叟，看⾒見見他們這樣⾟辛苦，取笑愚公說：「你不不是很愚蠢嗎？你已⼀把年年紀
了，就是⽤用盡你的氣⼒，也不不能挖去⼭山的⼀⻆角呢？」
愚公歎息道：「你有這樣的成⾒見見，是不不會明⽩白的。你⽐比那寡婦的⼩小兒⼦子還不不如呢！就算我死
了了，還有我的兒⼦子，我的孫⼦子，我的曾孫⼦子，他們⼀直傳下去。⽽而這⼆⼭是不不會加⼤大的，總有
⼀天，我們會把它們剷平。」
智叟聽了了，無話可說：
⼆⼭山的守護神被愚公的堅毅精神嚇倒，便便把此事奏知天帝。天帝佩服愚公的精神，就命兩位⼤大
⼒力力神揹⾛走⼆⼭山。
...
en_text = "".join(i for i in text if ord(i) < 256).replace("\n", " ")
cn_text = "".join(j for j in text if ord(j) > 256)

stats_text(en_text, cn_text)