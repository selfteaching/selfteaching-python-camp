#Selfteaching day7 homework ,creat a main.py program!

from mymodule import stats_word  #import module stats_word.py function
...
'''
print(stats_word.stats_text(text)) #output all the text words counts
