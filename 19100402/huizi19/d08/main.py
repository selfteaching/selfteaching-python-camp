...
##打印调试结果
print('------stats_text_en_check结果：')
stats_text_en_check(text)
print('------stats_text_cn_check结果：')
stats_text_cn_check(text)
print('------stats_text_check结果：')
stats_text_check(text)
