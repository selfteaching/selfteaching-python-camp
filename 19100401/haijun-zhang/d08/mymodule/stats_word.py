...
寒来暑往，他们要一年才能往返渤海一次。
住在黄河河畔的智叟，看见他们这样辛苦，取笑愚公说：「？你不是很愚蠢吗你已一把年​​纪了，就是用尽你的气力，也不能挖去山的一角呢」
愚公叹息道：！「你有这样的成见，是不会明白的你比那寡妇的小儿子还不如呢就算我死了，还有我的儿子，我的孙子，我的曾孙子，他们一直传下去。而这二山是不会加大的，总有一天，我们会把它们铲平」。
智叟听了，无话可说：
二山的守护神被愚公的坚毅精神吓倒，便把此事奏知天帝。天帝佩服愚公的精神，就命两位大力神背走二山。
愚蠢的老人如何移动山脉
愚公是一名九十岁的男子，住在泰兴山和王屋山两座高山的北面。
在广阔的土地上伸展，山脉阻挡了禹贡的方式，使他和他的家人不方便到处走动。
有一天，愚公与他的家人聚集在一起，说：“让我们尽力平整这两座山。我们将开辟一条通往禹州的道路。你怎么看？”
除了他的妻子之外，所有人都同意他
“你没有力量削减一个小土丘，”他的妻子喃喃道。“你觉得你怎么能把太辛山和万武山水平？所有的地球和碎石都会去哪里？“
“把它们扔进渤海之海！”大家说。
所以愚公，他的儿子和他的孙子开始分裂岩石并移走地球。他们将地球和碎石运到了渤海之海。
现在，愚公的邻居是一个寡妇，他的独生子只有八岁。晚上，小男孩急切地向他求助。
夏天过去了，冬天来了。愚公和他的船员整整一年来回走了一次。
在黄河岸边，住着一位因他的智慧而受到尊重的老人。当他看到他们的突破性劳动时，他嘲笑愚公说：“你不傻，我的朋友？你现在已经很老了，随着你力量的减弱，你甚至无法移除一座山的角落。“
愚公叹了口气说：“像你这样有偏见的人永远不会理解。你甚至无法与寡妇的小男孩比较！“
“即使我已经死了，仍然会有我的孩子，我的孙子孙女，我的曾孙子孙女，我的曾孙子孙女。他们的后代将永远继续下去。但是这些山脉不会长大。我们有一天会把它们放平！“他充满信心地宣布道。
聪明的老头完全沉默了。
...
def stats_text_en(text): #统计单词次数，使用字典（dict)统计text中每个英文单词出现的次数。
    if type(text)!=str:
        raise ValueError ("this is not a str type")   
    else:
...
def stats_text_ch(text):                  #统计汉字次数， 使用字典（dict)统计text中每个汉字出现的次数。
    if type(text)!=str:
        raise ValueError("this is not a str type") 
    else:
        dictionary={}  #引用一个空字典
