...
def stats_text_cn(text,count):
    ...
    sort_cn = Counter(words).most_common(count)
    #print(sort_cn)
    return sort_cn
...
import os
os.chdir(r'D:\用户目录\我的文档\GitHub\selfteaching-python-camp\19100401\Newonefromhere\d09')
f = open('tang300.json','r',encoding='utf8')
text2 = f.read()
resl_cn = stats_text_cn(text2,100)
print(resl_cn)