...
所属班级：19100105
学习用时：8.5小时
总结收获：对剔除、替换、列表与字符转换、排序有一定了解。今天的作业对我来说难度很大，最后参考了3班ljqbpm的作业才完成。后续还要反复阅读语法，直至理解其间的逻辑关系。同一个问题，每人表述的方式都不同，好的语言表达是简洁的，所以有必要多揣摩，找到不同的方式来实现。
遇到的难点与问题：虽然一些语法貌似掌握了，但实际解决问题时，又无从入手，就像手上有个齐备的工具箱，却不知道拿哪个用。