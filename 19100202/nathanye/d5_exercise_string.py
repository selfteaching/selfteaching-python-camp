...
a = text.split()  # Task2 将字符串中含"ea"的单词删除
...
print(text.replace('better', 'worse')) # Task3 将字符串中的better替换成worse

print(text.swapcase())  # Task4 将字符串中的大写转小写，小写转大写

print(sorted(a, key=str.lower)) # Task5 将所有单词按a...z升序排列
