...
#import Stats_word #导入stats_word模块
#print(Stats_word.stats_text(text)) #调用stats_word模块中的stats_text函数

try:    
    import Stats_word #import 
    print(Stats_word.stats_text(text)) #call function in Stats.word
