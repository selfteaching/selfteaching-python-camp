...
text2='''关于996，现在这是国内的一个很热门的话题，很多企业都有这个问题。我个人认为，能做996是一种巨大的福气，很多公司、很多人想996都没有机会。如果你年轻的时候不996，你什么时候可以996？
...
def stats_text_cn(text):
        if type(text)!=str:
                ...
                for i in text2:
                        ...
                        a[i]=text2.count(i)
        return a
result=sorted(stats_text_cn(text2).items(),key=lambda x:x[1],reverse=True)
print(result)
...
def stats_text(text):
        ...
        if type(text)!=str:
                raise ValueError('This is not str')
        return stats_text_cn,stats_text_en
